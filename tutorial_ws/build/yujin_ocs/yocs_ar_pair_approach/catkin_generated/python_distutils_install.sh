...
echo_and_run cd "/home/bp/tutorial_ws/src/yujin_ocs/yocs_ar_pair_approach"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/bp/tutorial_ws/src/yujin_ocs/yocs_ar_pair_approach/setup.py" \
     \
    build --build-base "/home/bp/tutorial_ws/build/yujin_ocs/yocs_ar_pair_approach" \
    install \
    --root="${DESTDIR-/}" \
